...
import { controllerProps, useGameController, type GameState } from "./controller.ts";
...
// controller"): its phone entry loads by game id and gets the latest view as props.
...
const bound = computed(() => controllerProps(props.state, send));
</script>
