...
| One hour, worst case: four players aiming for the whole 15 s timer and capping out every hole | 216 strokes over about 70 min, about 62 messages a stroke: **about 11,900 an hour** | One real-time phone for an hour is 14,400; platform.md's 4-phone real-time hour is about 64,000 | Yes, and it is the true ceiling |
