...
/**
 * The touch aim pad (docs/games/putt-club.md, "Touch controls"): a drag pad above the big action
 * and a quiet "Centre" button under it, which puts the line back on the flag. It only reports
 * pointers; `createAimDrag` (inside `putt.ts`) turns them into aim. One finger at a time drives it.
 */
...
.pad {
  ...
  inline-size: 100%;
  block-size: clamp(4.5rem, 16dvh, 7rem);
