...
/**
 * World Pips for Quick Draw: 16×24 pixel sprites with a 1px Ink outline (HOUSE_STYLE "Pips").
 * The Pip parts spec (CC-6) and the stage's World Pips (CC-6.4) don't exist yet, so this is a
 * simple placeholder built like the World Pip in the approved design canvas: a round head in the
 * player's skin tone with short hair, dot eyes, a jersey in the seat colour with a Chalk chest
 * mark. It faces right; the scene mirrors it for the Pips on the right.
 */
