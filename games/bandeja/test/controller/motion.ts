 ...
 * tail (well under `SWING_END_RATE`) long enough for the detector's own end-quiet window to close
 * the swing naturally, the way a real arm decelerates after the peak.
 */
export function swingBurst(from: number, durationMs: number, gamma: number): MotionSample[] {
