...
- [x] #3 After the owner approves the replay, VITE_REALTIME_LINK defaults to on in both apps and ?link=0 still turns the link off
<!-- AC:END -->
...
Owner approved (2026-09-20): 'Direct link for everyone.' VITE_REALTIME_LINK set to "true" in .github/workflows/deploy.yml's build step, so both apps default the link on in production; ?link=0 remains the per-visit escape hatch. Story Done.
<!-- SECTION:NOTES:END -->
