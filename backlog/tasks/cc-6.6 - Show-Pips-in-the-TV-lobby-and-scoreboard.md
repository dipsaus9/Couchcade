...
CI green on PR #138: check, check:deps, check:style, test, build, budgets, e2e all pass. Ready for the orchestrator's merge decision.
<!-- SECTION:NOTES:END -->
